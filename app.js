...
let nweSum=(a,b,c, d)=>a+b+c+d;



// TODO: Uncomment the following line of code to see the output in the browser console
console.log("sum by old function : ",sum(1, 2, 3, 4));
console.log(" sum by arrow function : ",nweSum(1, 2, 3, 4));
...
console.log("use arrow function  :",newObjec());
...
console.log("sumAndProduct use arrow funaction", newSumAndProduct(3, 9));
...
let newMassage=name=>`Hello, ${name}!`;

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(message('Allie'));
console.log("massage use arrow function",newMassage('Allie'));
...
let newjoe = newStudent('Joe Schmoe', 100, 'Anytown, USA');
...
newjoe.newgreeting=()=>`Hi, my name is ${newjoe.name}`;

// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this method to break!
console.log(joe.greeting());
console.log("use arrow function",newjoe);
console.log(newjoe.newgreeting());
...
let newCOURSNAME=()=>'This student is enrolled in Code 301.';
...
//is refer to the object in the construction function
// 2. What is "this" when joe.scopeArrow() is invoked?
//is refeer to the HTML file ,thw js see the html file as object so it's consol.log the html fil as object
